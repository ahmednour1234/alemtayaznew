...
return [
    ...
    'reserve' => [
        ...
        'cancel_confirm'  => 'Cancel the reservation for ":name" and make it available again?',
        'cancelled'       => 'Reservation cancelled — the CV is available again.',
        'tamara'          => 'Tamara paid',
        'tamara_confirm'  => 'Confirm the client paid via Tamara? The hold extends to :days days.',
        'tamara_done'     => 'Tamara payment recorded — hold extended to :days days.',
        'tamara_denied'   => 'You cannot record this payment — the reservation is not yours or is already recorded.',
        'tamara_paid'     => 'Paid via Tamara',
