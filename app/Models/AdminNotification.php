...
class AdminNotification extends Model
{
    ...
    public function getIconSvgAttribute(): string
    {
        return match ($this->type) {
            ...
            'housing_visit_created' => '<svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M3 21h18M3 7l9-4 9 4M4 7v14h16V7M8 13h8M8 17h5"/></svg>',
            'housing_visit_updated' => '<svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M3 21h18M3 7l9-4 9 4M4 7v14h16V7"/><path d="M16 11l3 3-5 5h-3v-3l5-5z"/></svg>',
    ...
    public function getIconColorAttribute(): string
    {
        return match ($this->type) {
            ...
            'housing_visit_created'        => '#0f766e',
            'housing_visit_updated'        => '#2563eb',
            'trip_created'     => '#2563eb',
    ...
    public function getIconBgAttribute(): string
    {
        return match ($this->type) {
            ...
            'housing_visit_created'        => '#ccfbf1',
            'housing_visit_updated'        => '#dbeafe',
