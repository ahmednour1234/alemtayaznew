...
class Admin extends Authenticatable
{
    ...
    public function housingVisits(): BelongsToMany
    {
        return $this->belongsToMany(HousingVisit::class, 'housing_visit_admin')
            ->withTimestamps();
    }

    public function createdHousingVisits(): HasMany
    {
