...
<div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
    <div class="px-5 py-3 border-b bg-green-50">
        <h3 class="font-semibold text-green-700">الإيرادات</h3>
    </div>
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
    <div class="px-5 py-3 border-b bg-blue-50">
        <h3 class="font-semibold text-blue-700">التحويلات</h3>
    </div>
    <table class="w-full text-sm">
        <thead class="bg-slate-50 text-slate-500 text-xs border-b">
            <tr>
                <th class="px-4 py-2 text-right">التاريخ</th>
                <th class="px-4 py-2 text-right">النوع</th>
                <th class="px-4 py-2 text-right">الجهة</th>
                <th class="px-4 py-2 text-right">المبلغ</th>
            </tr>
        </thead>
        <tbody class="divide-y divide-slate-100">
            ...
            <tr class="hover:bg-blue-50">
                ...
                <td class="px-4 py-2"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">وارد</span></td>
                <td class="px-4 py-2">{{ $t->fromBranch?->name ?? 'خارجي' }}</td>
            ...
            <tr class="hover:bg-purple-50">
                <td class="px-4 py-2">{{ $t->date?->format('Y-m-d') }}</td>
                <td class="px-4 py-2"><span class="text-xs bg-purple-100 text-purple-700 px-2 py-0.5 rounded">صادر</span></td>
                <td class="px-4 py-2">{{ $t->toBranch?->name ?? 'خارجي' }}</td>
