...
@section('title', 'رفع وثيقة')
@section('content')
<div class="flex justify-between items-center mb-6">
    <h2 class="text-xl font-bold text-slate-800">رفع وثيقة جديدة</h2>
...
<div class="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
    <form method="POST" action="{{ route('admin.hr.documents.store') }}" enctype="multipart/form-data">
        ...
        <div class="mt-6 flex gap-3">
            <button class="bg-blue-600 hover:bg-blue-700 text-white text-sm px-6 py-2.5 rounded-lg">رفع</button>
