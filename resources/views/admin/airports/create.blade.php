...
<div class="max-w-lg">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-slate-800">إضافة مطار</h2>
    </div>

    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('admin.airports.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" name="code" value="{{ old('code') }}" maxlength="10" placeholder="مثال: RUH"
