...
@section('content')
<div class="w-full" x-data="{ selected: [], waPhone: '', showWa: false }">
    ...
    <div x-show="selected.length > 0" x-cloak
        ...
        <div class="flex flex-wrap items-center gap-3">
            <div class="flex items-center gap-2">
                ...
                <span class="bg-green-600 text-white text-xs px-2 py-0.5 rounded-full" x-text="selected.length + ' CV محدد'"></span>
            </div>
            <form @submit.prevent="sendWhatsapp(selected, waPhone)" class="flex gap-2 flex-1 min-w-0">
                ...
                <button type="submit"
                        class="bg-green-600 hover:bg-green-700 text-white text-sm px-4 py-2 rounded-lg font-medium whitespace-nowrap">
                    إرسال
                </button>
            </form>
