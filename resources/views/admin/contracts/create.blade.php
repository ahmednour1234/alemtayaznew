        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div>
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="text-xs text-slate-400 bg-slate-100 rounded-lg px-3 py-1">✦ حدد التاريخ عند الانتهاء من كل مرحلة</span>
                </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex flex-wrap items-center gap-x-3 gap-y-0.5 mb-1">
                                    ...
                                    @if($st['days'])
                                    <span class="text-xs text-orange-500 bg-orange-50 rounded px-1.5 py-0.5">⏱ {{ $st['days'] }} أيام متوقعة</span>
                                    @endif
                                </div>
