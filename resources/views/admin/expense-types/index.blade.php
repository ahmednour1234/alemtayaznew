...
@section('title', 'أنواع المصاري�')
@section('content')

<div class="flex justify-between items-center mb-6">
    <h2 class="text-xl font-bold text-slate-800">أنواع المصاري�</h2>
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-slate-100">
            ...
            @empty
            <tr><td colspan="5" class="px-4 py-8 text-center text-slate-400">لا توجد أنواع مصاري�</td></tr>
            @endforelse
        </tbody>
    </table>
    @if($types->hasPages())
