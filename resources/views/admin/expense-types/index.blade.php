...
@section('title', 'أنواع المصاريف')
@section('content')

<div class="flex justify-between items-center mb-6">
    <h2 class="text-xl font-bold text-slate-800">أنواع المصاريف</h2>
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-slate-100">
            ...
            <tr class="hover:bg-slate-50">
                ...
                <td class="px-4 py-3">
                    <div class="flex gap-2">
                        ...
                        <form action="{{ route('admin.expense-types.toggle', $type->id) }}" method="POST" class="inline">
                            @csrf
            ...
            @empty
            <tr><td colspan="5" class="px-4 py-8 text-center text-slate-400">لا توجد أنواع مصاريف</td></tr>
            @endforelse
        </tbody>
    </table>
    @if($types->hasPages())
