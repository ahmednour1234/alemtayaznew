...
<div class="w-full">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-slate-800">إضا�ة نوع مصرو�</h2>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('admin.expense-types.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="{{ route('admin.expense-types.index') }}" class="bg-slate-200 hover:bg-slate-300 text-slate-700 text-sm px-6 py-2.5 rounded-lg">إلغاء</a>
            </div>
        </form>
    </div>
</div>
