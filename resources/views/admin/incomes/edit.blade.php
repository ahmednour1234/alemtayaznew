...
@section('title', 'ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„Ø¥ÙŠØ±Ø§Ø¯')
@section('content')
<div class="w-full">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-slate-800">ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„Ø¥ÙŠØ±Ø§Ø¯</h2>
    </div>
        ...
        <form action="{{ route('admin.incomes.update', $income->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                @if($income->attachment)
                    <a href="{{ Storage::url($income->attachment) }}" target="_blank" class="text-blue-600 text-xs hover:underline block mb-2">Ø¹Ø±Ø¶ Ø§Ù„Ù…Ø±ÙÙ‚ Ø§Ù„Ø­Ø§Ù„ÙŠ</a>
                @endif
