...
@section('title', 'ØªØ¹Ø¯ÙŠÙ„ Ù†ÙˆØ¹ Ø¯Ø®Ù„')
@section('content')
<div class="w-full">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('admin.income-types.update', $type->id) }}" method="POST" class="space-y-4">
            @csrf @method('PUT')
            <div>
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="{{ route('admin.income-types.index') }}" class="bg-slate-200 hover:bg-slate-300 text-slate-700 text-sm px-6 py-2.5 rounded-lg">Ø¥Ù„ØºØ§Ø¡</a>
            </div>
        </form>
    </div>
</div>
