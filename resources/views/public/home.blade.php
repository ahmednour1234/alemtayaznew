    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 py-14">
        <div class="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
            ...
            <div class="flex flex-wrap gap-3 justify-center lg:justify-end">
                <a href="{{ route('site.contact') }}"
                   class="inline-flex items-center gap-2 bg-gold hover:bg-gold-dark text-white font-bold px-7 py-3.5 rounded-xl shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                ...
                <a href="https://wa.me/{{ preg_replace('/\D/', '', $S('whatsapp')) }}" target="_blank" rel="noopener"
                   class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-7 py-3.5 rounded-xl backdrop-blur-sm hover:-translate-y-0.5 transition-all duration-300">
